...
Certifique-se de ter o arquivo logistica_transporte.csv no mesmo diretório.

Abra o notebook no Google Colab ou ambiente Jupyter local.

Execute as células para gerar a matriz de correlação e os gráficos de dispersão.
